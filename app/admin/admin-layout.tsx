        ...
        return (
          <Link
            ...
            className={cn(
              ...
              isActive ? "bg-[#C4D600] text-black font-medium" : "text-gray-700 hover:bg-gray-100",
            )}
          >
        ...
        <div key={item.label} className="space-y-1">
          <button
            ...
            className={cn(
              ...
              hasActiveChild ? "bg-gray-100 font-medium" : "text-gray-700 hover:bg-gray-100",
            )}
          >
              ...
              {item.items.map((subItem) => {
                ...
                return (
                  <Link
                    ...
                    onClick={() => isMobile && setSidebarOpen(false)}
                    className={cn(
                      "flex items-center justify-between gap-3 px-4 py-2 rounded-lg transition-colors text-sm",
                      isActive ? "bg-[#C4D600] text-black font-medium" : "text-gray-600 hover:bg-gray-50",
                    )}
                  >
        ...
        <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-white border-r">
          ...
          <div className="p-6 border-b">
            <Link href="/admin" className="flex items-center gap-3">
              ...
              <div>
                <span className="font-bold text-lg block">Creative Fusion</span>
                <span className="text-xs text-gray-500">AI Admin Panel</span>
              </div>
            </Link>
          </div>
          ...
          <div className="p-4 border-t space-y-2">
            <Link href="/" className="flex items-center gap-2 px-4 py-2 text-sm text-gray-600 hover:text-gray-900">
              <span>View Website</span>
            </Link>
            <form action="/auth/signout" method="post">
              <Button variant="outline" className="w-full justify-start text-sm bg-transparent" type="submit">
